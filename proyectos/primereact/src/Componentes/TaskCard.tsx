...
type Task = {
  ...
  archivo:string;
  portada: string | null; // Puede ser null si no hay portada
};
...
const TaskCard: React.FC<TaskCardProps> = ({ task }) => {
  ...
  const title = (
    ...
    <div className="div1 text-truncate" style={{maxWidth:'250'}}>  <label >{task.title}</label></div>
    <div className="div2"><label className="" style={{fontSize:'13px' , float:'right'}}>
