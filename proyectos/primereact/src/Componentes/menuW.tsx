...
function MenuW() {
  const abrirmenuh = useState(false);
  ...
  // Función para cerrar el sidebar al hacer click en el fondo
  ...
  return (
    <>
      ...
      {/* Fondo transparente para cerrar el sidebar */}
      {isSidebarOpen && (
        <div
          id="overlay"
          ...
          style={{
            ...
            zIndex: 1, // Asegura que el overlay quede por encima del contenido
          }}
        ></div>
      )}
      ...
      <div
        ...
        style={{
          ...
          background: "#3B3C36",
          zIndex: 2, // Asegura que el sidebar esté encima del overlay
        }}
        id="mySidebar"
      >
        <div
